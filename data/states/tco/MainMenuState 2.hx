...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['freeplay','storymode','credits','art_gallery',//I know that this mod is not getting ported to web but uh I was bored
		'vault','options'
	];
			...
			else
			{
				...
				new FlxTimer().start(1.5, function(tmr:FlxTimer)
				{
					...
					switch (daChoice) {
						...
						else FlxG.switchState(new TCOStoryState());
						case 'freeplay':FlxG.switchState(new FreeplayMenu());
						case 'art_gallery':FlxG.switchState(new FanArtState());
						case 'credits':FlxG.switchState(new TCOCreditsState());
