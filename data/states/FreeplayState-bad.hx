...
var egth:CustomShader= new CustomShader("VHSGlitchShader"); 
...
function postUpdate(elapsed:Float) {
	...
	egth.data.iTime.value=[time_4654];
	egth.data.iResolution.value=[34453645678,45765757];
}