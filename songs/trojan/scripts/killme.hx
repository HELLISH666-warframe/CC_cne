...
function beatHit(curBeat:Int) {
    switch(curBeat)
	{
		...
		case 64 | 224 | 320:
		bestPart2 = true;
		colorTween([gf, stage.getSprite("alanBG"), stage.getSprite("tscseeing"), stage.getSprite("sFWindow"), stage.getSprite("adobeWindow"), stage.getSprite("daFloor")], 0.1, FlxColor.WHITE, 0xFF191919);
		stage.getSprite("radialLine").alpha = 1;
		...
		bestPart2 = false;
		colorTween([gf, stage.getSprite("alanBG"), stage.getSprite("tscseeing"), stage.getSprite("sFWindow"), stage.getSprite("adobeWindow"), stage.getSprite("daFloor")], 0.8, 0xFF191919, FlxColor.WHITE);
		stage.getSprite("radialLine").alpha = 0.0001;
		redthing.alpha = 0;
		...
		filter.alpha = 0.0001;
		gf.alpha = 0.0001;
		colorTween([stage.getSprite("alanBG"), stage.getSprite("tscseeing"), stage.getSprite("sFWindow"), stage.getSprite("adobeWindow"), stage.getSprite("daFloor")], 0.8, 0xFF191919, FlxColor.BLACK);
		case 384:
		colorTween([gf, stage.getSprite("alanBG"), stage.getSprite("tscseeing"), stage.getSprite("sFWindow"), stage.getSprite("adobeWindow"), stage.getSprite("daFloor")], 0.8, 0xFF191919, FlxColor.WHITE);
		...
		gf.alpha = 1;
		filter.alpha = 1;
		stage.getSprite("radialLine").alpha = 0;
		case 388:
		boyfriend.setColorTransform(1, 1, 1, 1, 0, 0, 0, 0);
		case 400:
		camGame.alpha = 0;
